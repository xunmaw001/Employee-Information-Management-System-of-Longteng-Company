                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            ...
                                            <label>
                                                用户状态
                                                <select name="zhuangtaiTypesSelectSearch" id="zhuangtaiTypesSelectSearch" class="form-control form-control-sm"
                                                        aria-controls="tableId">
                                                </select>
                                            </label>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //居住地
        var residenceCell = document.createElement('td');
        residenceCell.innerHTML = item.residence;
        ...
        //婚姻状况
        var marriageTypesCell = document.createElement('td');
        marriageTypesCell.innerHTML = item.marriageValue;
        row.appendChild(marriageTypesCell);
