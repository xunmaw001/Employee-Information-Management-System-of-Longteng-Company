            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">面试管理</li>
                        <li class="breadcrumb-item active">面试列表</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        row.appendChild(myPhotoCell);
                    ...
                    //学历
        var educationTypesCell = document.createElement('td');
        educationTypesCell.innerHTML = item.educationValue;
        row.appendChild(educationTypesCell);


                //毕业学校
        var schoolCell = document.createElement('td');
        schoolCell.innerHTML = item.school;
        row.appendChild(schoolCell);



        //招聘id
        var zhaopinIdCell = document.createElement('td');
        zhaopinIdCell.innerHTML = item.zhaopinId;
        row.appendChild(zhaopinIdCell);


        //面试时间
        var mianshiTimeCell = document.createElement('td');
        mianshiTimeCell.innerHTML = item.mianshiTime;
        row.appendChild(mianshiTimeCell);


        //面试结果
        var mianshiTypesCell = document.createElement('td');
        mianshiTypesCell.innerHTML = item.mianshiValue;
        row.appendChild(mianshiTypesCell);


        //面试评价
        var mianshiContentCell = document.createElement('td');
        mianshiContentCell.innerHTML = item.mianshiContent;
        row.appendChild(mianshiContentCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("mianshi/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addmianshi", "addmianshi");
        window.location.href = "add-or-update.jsp"
    }
