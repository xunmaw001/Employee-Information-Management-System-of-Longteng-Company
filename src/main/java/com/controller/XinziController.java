...
public class XinziController {
    ...
    */
    ...
    public R save(@RequestBody XinziEntity xinzi, HttpServletRequest request){
        ...
        //  }
            ...
            return R.error(511,"该员工的该月份已经有薪资条了");
        }
    }
    ...
    */
    public void dictionaryConvert(XinziView xinziView){
        ...
        if(StringUtil.isNotEmpty(String.valueOf(xinziView.getMarriageTypes()))){
            xinziView.setMarriageValue(dictionaryMap.get("marriage_types").get(xinziView.getMarriageTypes()));
        }
        if(StringUtil.isNotEmpty(String.valueOf(xinziView.getEducationTypes()))){
            xinziView.setEducationValue(dictionaryMap.get("education_types").get(xinziView.getEducationTypes()));
        }
        if(StringUtil.isNotEmpty(String.valueOf(xinziView.getZhuangtaiTypes()))){
            xinziView.setZhuangtaiValue(dictionaryMap.get("zhuangtai_types").get(xinziView.getZhuangtaiTypes()));
        }
    }
