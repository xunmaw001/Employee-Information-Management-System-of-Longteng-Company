...
public class QingjiaController {
    ...
    */
    public void dictionaryConvert(QingjiaView qingjiaView){
        ...
        if(StringUtil.isNotEmpty(String.valueOf(qingjiaView.getMarriageTypes()))){
            qingjiaView.setMarriageValue(dictionaryMap.get("marriage_types").get(qingjiaView.getMarriageTypes()));
        }
        if(StringUtil.isNotEmpty(String.valueOf(qingjiaView.getEducationTypes()))){
            qingjiaView.setEducationValue(dictionaryMap.get("education_types").get(qingjiaView.getEducationTypes()));
        }
        if(StringUtil.isNotEmpty(String.valueOf(qingjiaView.getZhuangtaiTypes()))){
            qingjiaView.setZhuangtaiValue(dictionaryMap.get("zhuangtai_types").get(qingjiaView.getZhuangtaiTypes()));
        }
    }
